 ...
 *
 */
#ifndef IGNITION_GAZEBO_SYSTEMS_PROPELLER_HH_
#define IGNITION_GAZEBO_SYSTEMS_PROPELLER_HH_
...
namespace systems
{
    ...
    public ISystemPreUpdate
  {
    ...
    private: std::unique_ptr<PropellerPrivateData> dataPtr;
  };
}
}
}
